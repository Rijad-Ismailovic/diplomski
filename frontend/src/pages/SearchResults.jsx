...
function SearchResults() {
  ...
  useEffect(() => {
    ...
    const hasQuery = departure || arrival || departureDate || returnDate || wifi || restroom || ac || outlet || reclining || maxPrice || maxDuration;

    if (hasQuery) {
      search(departure, arrival, departureDate, returnDate, wifi, restroom, ac, outlet, reclining, maxPrice, maxDuration)
